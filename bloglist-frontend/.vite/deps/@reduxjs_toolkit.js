import { __publicField } from "./chunk-ZC22LKFR.js";
...
function isDraftable(value) {
  ...
  return (
    ...
    Array.isArray(value) ||
    !!value[DRAFTABLE] ||
    !!((_a = value.constructor) == null ? void 0 : _a[DRAFTABLE]) ||
    isMap(value) ||
    isSet(value)
  );
}
...
var Immer2 = class {
  constructor(config) {
    ...
    if (
      typeof (config == null ? void 0 : config.useStrictShallowCopy) ===
      "boolean"
    )
    ...
    if (cacheNode.s === TERMINATED) {
      ...
      if (resultEqualityCheck) {
        const lastResultValue =
          ((_a = lastResult == null ? void 0 : lastResult.deref) == null
            ? void 0
            : _a.call(lastResult)) ?? lastResult;
        if (
  ...
  function createAsyncThunk2(typePrefix, payloadCreator, options) {
    ...
    function actionCreator(arg, { signal } = {}) {
      return (dispatch, getState, extra) => {
        const requestId = (options == null ? void 0 : options.idGenerator)
          ...
          try {
            ...
            dispatch(
              pending(
                requestId,
                arg,
                (_b = options == null ? void 0 : options.getPendingMeta) == null
                  ? void 0
                  : _b.call(
                      options,
                      {
...
function buildCreateSlice({ creators } = {}) {
  var _a;
  const cAT =
    (_a = creators == null ? void 0 : creators.asyncThunk) == null
      ? void 0
      : _a[asyncThunkSymbol];
    ...
    updates.forEach((update) => {
      ...
      if (update.id in state.entities) {
        updatesPerEntity[update.id] = {
          ...
          changes: {
            ...((_a = updatesPerEntity[update.id]) == null
              ? void 0
              : _a.changes),
            ...update.changes,
          },
...
var createListenerEntry = assign(
  (options) => {
